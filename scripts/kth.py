...
class KTH(Dataset):
    ...
    def __init__(self, directory, frames_per_item = 20, transform=None, download = False):
    ...
    def prepare_data(self):       
        ...
        if(self.__download):
            self.__process_video_frames(self.__data, self.__directory + '/data4', self.__transform)
    ...
    def __getitem__(self, idx):
        item_data = torch.load(self.__directory + '/data3/' + str(idx) + '.pt')
    ...
    def train_test(self,train):
        ...
        fulldataset = KTH(directory=self.__directory, transform=self.__transform)
        subset_datasets = {}
...
"""train_data = KTH(
    directory="C://users//aysha//Cuda lab//KTH",
